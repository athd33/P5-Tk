...
# HOME PAGE
Label(HomePage,
      text='', bg='green', width=30).grid(row=0, column=0, pady=4)
Label(HomePage,
      text='Accueil', width=40).grid(row=0, column=1, pady=4)
Label(HomePage,
      text='', bg='red', width=30).grid(row=0, column=2, pady=4)
Button(HomePage,
       text="Créer un compte",
       command=lambda: raise_frame(RegisterPage)).grid(row=1, column=1, pady=5)
Button(HomePage,
       text="M'authentifier",
       command=lambda: raise_frame(LoginPage)).grid(row=2, column=1, pady=5)
Button(HomePage,
       text="Quitter",
       command=lambda: quitt_app()).grid(row=3, column=1, pady=5)


# REGISTER PAGE
Label(RegisterPage,
      text='', bg='green', width=30).grid(row=0, column=0, pady=5)
Label(RegisterPage,
      text='AUTHENTIFICATION', width=40).grid(row=0, column=1, pady=5)
Label(RegisterPage,
      text='', bg='red', width=30).grid(row=0, column=2, pady=5)
Label(RegisterPage,
      text='', bg='green', width=30).grid(row=1, column=0, pady=5)
Label(RegisterPage,
      text="Nom d'utilisateur").grid(row=1, column=1, pady=2)
username = StringVar()
Label(RegisterPage,
      text='', bg='green', width=30).grid(row=1, column=0, pady=5)
Entry(RegisterPage,
      textvariable=username).grid(row=2, column=1, pady=2)
Label(RegisterPage,
      text="Mot de passe").grid(row=3, column=1, pady=2)
psswd = StringVar()
Entry(RegisterPage,
      show="*", textvariable=psswd).grid(row=4, column=1, pady=2)
Label(RegisterPage,
      text="Confirmez le mot de passe").grid(row=5, column=1, pady=2)
confirm = StringVar()
Label(RegisterPage,
      text='', width=30).grid(row=1, column=0, pady=5)
Entry(RegisterPage,
      show="*", textvariable=confirm).grid(row=6, column=1, pady=2)
Button(RegisterPage,
       text="SUBMIT",
       command=lambda:
       check_register_info(
...
Button(RegisterPage,
       text="Accueil",
       command=lambda: raise_frame(HomePage)).grid(row=8, column=1, pady=5)
Button(RegisterPage,
       text="Authentification",
       command=lambda: raise_frame(LoginPage)).grid(row=9, column=1, pady=5)
Button(RegisterPage,
       text="Quitter",
       command=lambda: quitt_app()).grid(row=10, column=1, pady=5)
...
Label(LoginPage,
      text='', bg='red', width=30).grid(row=0, column=2, pady=5)
Label(LoginPage,
      text="Votre nom d'utilisateur").grid(row=1, column=1, pady=2)
nameLogin = StringVar()
...
Entry(LoginPage,
      show="*", textvariable=psswdLogin).grid(row=4, column=1, pady=2)
Button(LoginPage,
       text="Valider",
       command=lambda: check_creds_info(
            nameLogin.get(),
            psswdLogin.get())).grid(row=5, column=1, pady=5)
Button(LoginPage,
       text="Accueil",
       command=lambda: raise_frame(HomePage)).grid(row=6, column=1, pady=5)
Button(LoginPage,
       text="Quitter",
       command=lambda: quitt_app()).grid(row=7, column=1, pady=5)
...
Label(CategoryPage,
      text='',
      width=30,
      bg='green').grid(row=0, column=0, pady=5)
Label(CategoryPage,
      text='    CATEGORIES  ', width=40).grid(row=0, column=1, pady=5)
Label(CategoryPage,
      text='', width=30, bg='red').grid(row=0, column=2, pady=5)
Label(CategoryPage,
      text="Quel aliment souhaitez-vous remplacer ? :").grid(
        row=1,
        column=1,
        pady=30)
...
Button(CategoryPage,
       text="Accueil",
       command=lambda: raise_frame(HomePage)).grid(row=20, column=1,)
Button(CategoryPage,
       text="Quitter", command=lambda: quitt_app()).grid(row=21, column=1)
Button(CategoryPage,
       text="Retrouver mes\n aliments substitués",
       command=lambda:
...
# ALIMENTS PAGE
Label(AlimentsPage,
      text='', width=30, bg='green').grid(row=0, column=0, pady=5)
Label(AlimentsPage,
      text='ALIMENTS', width=30).grid(row=0, column=1, pady=5)
Label(AlimentsPage,
      text='', width=35, bg='red').grid(row=0, column=2, pady=5)
Label(AlimentsPage,
      text='Veuillez sélectionner un \naliment \
            dans la liste suivante:').grid(row=1, column=1)
...
Button(AlimentsPage,
       ...
       get_alternative(
           alimentNumber.get(),
           categoryList)).grid(row=4, column=1, pady=3)
Button(AlimentsPage,
       text="Retour",
       command=lambda:
       raise_frame(CategoryPage)).grid(row=5, column=0, pady=2)
Button(AlimentsPage,
       text="Accueil", command=lambda:
       raise_frame(HomePage)).grid(row=5, column=2, pady=2)
Button(AlimentsPage,
       text="Quitter", command=lambda:
       quitt_app()).grid(row=6, column=1, pady=2)
...
Label(AlternativePage,
      text='', width=30, bg='green').grid(row=0, column=0, pady=5)
Label(AlternativePage,
      text='ALTERNATIVE', width=30).grid(row=0, column=1, pady=5)
Label(AlternativePage,
      text='', width=35, bg='red').grid(row=0, column=2, pady=5)
Label(AlternativePage,
      text='Voici une alternative \n   qui\
...
Label(AlternativePage,
      ...
      anchor="nw", justify="left").grid(row=2, column=0, columnspan=3)
Button(AlternativePage,
       text="Enregistrer",
       command=lambda:
       dump_product(product, user)).grid(row=3, column=1, pady=3)
Button(AlternativePage,
       text="Retour",
       command=lambda:
       raise_frame(CategoryPage)).grid(row=4, column=1, pady=2)
Button(AlternativePage,
       text="Accueil",
       command=lambda:
       raise_frame(CategoryPage)).grid(row=5, column=1, pady=2)
Button(AlternativePage,
       text="Quitter",
       command=lambda:
       quitt_app()).grid(row=6, column=1, pady=2)
...
Label(HistoryPage,
      text='', width=30, bg='green').grid(row=0, column=0, pady=5)
Label(HistoryPage,
      text='RECHERCHES SAUVEGARDEES', width=40).grid(row=0, column=1, pady=5)
Label(HistoryPage,
      text='', width=30, bg='red').grid(row=0, column=2, pady=5)
Label(HistoryPage,
      text='Voici les recherches enregistrées:').grid(row=1, column=1)
...
Button(HistoryPage,
       text="Aliments",
       command=lambda:
       raise_frame(AlimentsPage)).grid(row=6, column=1, pady=2)
Button(HistoryPage,
       text="Quitter",
       command=lambda: quitt_app()).grid(row=7, column=1, pady=2)
